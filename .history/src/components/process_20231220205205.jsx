    ...
    return (
       ...
       <Navbar/>
        ...
        <div className="process-container">
            ...
            Q3 Visuals in one of the most fundamental laws of physics:
            For every action, there is an equal and opposite reaction.
            So the question is? What actions can we take to ensure we 
            can create a website that elevates your brand as much as possible?

            Here are some tenets we use to make it happen
            </p>
