  ...
  const returnAnimations = [
    ...
    return (
        <div className='tenet-star-container'>
            ...
            <motion.div 
            onClick={()=>animationClick()}
            initial={isAnimated ? tenetAnimation.initial :returnTenetAnimation.animate }
            animate={
                isAnimated ?
                 tenetAnimation.animate : returnTenetAnimation.iniital}
                 transition={tenetAnimation.transition}
