    ...
    <div className="about-container">
      ...
      >
        ...
        <motion.li
          initial={{ x: -400,  }}
            animate={{ x: 0, opacity: 1, transition: {  duration: 1 } }}
            >Competitive Edge: Gain a significant advantage—around 40% of small businesses still don't have a website.</motion.li>
        <motion.li 
         initial={{ x: -400,  }}
         animate={{ x: 0, opacity: 1, transition: {  duration: 1 } }}
         >Compelling Content: Showcase your unique value proposition and engage your audience.</motion.li>
        <motion.li
          initial={{ x: -400,  }}
            animate={{ x: 0, opacity: 1, transition: {  duration: 1 } }}
            >Lead Generation: Convert visitors into customers with effective lead capture mechanisms.</motion.li>
        <motion.li
         initial={{ x: -400,  }}
         animate={{ x: 0, opacity: 1, transition: {  duration: 1 } }}
          >Brand Credibility: Establish trust and credibility by presenting a polished online presence.</motion.li>
      </motion.ul>
    </div>
  );
};
