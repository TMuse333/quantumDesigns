...
import brain from 'src/images/Gemini_Generated_Image_7x676t7x676t7x67-removebg-preview.png'
const Infographic = () => {
    ...
    <div className="infographic-container">
      ...
      <div className="infographic-intro">
        ...
        <p style={style} className="description-text ">
          ...
          Your brand is fantastic and it deserves a website that reflects that.
          We use react js, the software that instagram, facebook advantage
          other big companies use on their websites to ensure
          you stand out among all the generic websites out there.
        </p>
