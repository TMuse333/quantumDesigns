...
const Testimonials = () => {
  ...
  return (
    <div className="testimonial-container">
      ...
      <h2 className=" deliver">We <span className="bold-700">Deliver</span>  <span className="bold-700">Results</span> </h2>
      <p className='description-text'>Our clients have experienced <span className="bold-700"></span>monumental success in elevating their digital presence with our expertly crafted websites. Transform your brand's online identity today  </p>
