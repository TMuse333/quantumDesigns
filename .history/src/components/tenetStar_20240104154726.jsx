...
const animations = [
    ...
    },
    {
      ...
      animate: { x: 0, y: 0, opacity: 1, scale: 1 },
      transition: { delay: 0.6, scale: { delay: 1.8 }, opacity: { delay: 0 } },
    },
    {
      initial: { x: 200, y: -100, opacity: 1, scale: 0.2 },
      animate: { x: 0, y: 0, opacity: 1, scale: 1 },
      transition: { delay: 0.9, scale: { delay: 1 }, opacity: { delay: 0 } },
    },
    {
      initial: { x: -200, y: -100, opacity: 1, scale: 0.2 },
      animate: { x: 0, y: 0, opacity: 1, scale: 1 },
      transition: { delay: 1.2, scale: { delay: 1.4 }, opacity: { delay: 0 } },
    },
  ];
