        ...
        <div className="process-container">
            ...
            <div className="video-container">
                    ...
                    <p className="description-text small">
                        ...
                        <p className="description-text">
                            Take action now and <span className='bold-700'>level up</span> your business,<span className='bold-700'></span> win over your competition and
                             achieve your goals with Q3 Visuals.
