...
const Infographic = () => {
  ...
  const [activeAdvantages, setActiveAdvantages] = useState(designAdvantages);
  ...
  const handleToggle = () => {
    setActiveAdvantages((prevAdvantages) =>
      prevAdvantages === designAdvantages ? performanceAdvantages : designAdvantages
    );
  ...
  return (
    <div className="infographic-container">
      ...
      <div className="infographic-intro">
        ...
        <div className="advantage-selector">
          <button className="button" onClick={handleToggle}>
            {activeAdvantages === designAdvantages ? "Design" : "Performance"}
          </button>
        </div>
      </div>
      ...
      <div className="info-image-box">
        ...
        >
          <p className="description-text">{activeAdvantages.description}</p>
        </motion.div>
      </div>
      ...
      >
        {activeAdvantages.points.map((design, index) => (
          <div
            key={index}
