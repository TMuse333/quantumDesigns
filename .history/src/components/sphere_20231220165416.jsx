...
const Sphere = ({ size, position = { x: 0, y: 0, z: 0 } }) => {
  ...
  useEffect(() => {
    ...
    const torusMaterial = new THREE.MeshBasicMaterial({ color: 'blue', transparent: true, opacity: 0.7 });
    ...
    // Set sphere position
    sphere.position.set(0, position.y, position.z);
  ...
  return <div className='sphere'
   ref={containerRef} style={{ width: `${size}px`, height: `${size}px` }} />;
};
