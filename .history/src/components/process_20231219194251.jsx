    ...
    <div>
      ...
      <div className="process-container">
        ...
        <p className="description-text">
          Experience enhanced website performance with Q3 Visuals. Elevate your
          business and captivate audiences. Discover our guiding principles.
        </p>

        <div className="tenet-container">
          <IoIosArrowBack onClick={prevTenet} className="arrow" />
          <div key={currentTenet}>
        ...
        <div className="outro-container">
          <p className="description-text small">Its time to level up</p>
          ...
          <p className="description-text">
            Take action now and{" "}
            <span className='bold-700'>level up</span> your business,{" "}
            <span className='bold-700'>win </span> over your competition and{" "}
            <span className='bold-700'>achieve </span> your goals with Q3 Visuals.
          </p>
