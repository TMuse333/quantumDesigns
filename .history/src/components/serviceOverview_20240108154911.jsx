    ...
    const [showScrollDownAnimation, setShowScrollDownAnimation] = useState(true);
     ...
     const handleScroll = () => {
      ...
      <p className="description-text">
              ...
              to help you stand out from all the boring
              and repeated templates you see online, you will stand out!
            ...
            >
              ...
              <p className="description-text">{service.description}</p>
                    ...
                    <div className="backend-services">
                      For more functional aspects of your website,
                      we can use shopify or wordpress to
                      ensure you are working with industry standard
                      softwares to ensure everything works great!
                    </div>
