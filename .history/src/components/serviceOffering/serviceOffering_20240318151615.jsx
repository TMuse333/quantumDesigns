...
const ServiceOffering = ({ isAnimated }) => {
  ...
  return (
    <div ref={servicesRef}>
      <h2 className="title-text service-offering">Customizable web solutions to grow your online brand</h2>
      <div className="service-offering-container">
        <div className="offered-service">
          <p className="description-text">
           ...
           We don't use generic templates, instead we create custom built
           websites with so you stand out above the rest, here are some
