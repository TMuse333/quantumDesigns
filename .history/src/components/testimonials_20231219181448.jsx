...
const Testimonials = () => {
  ...
  return (
   ...
   <div >
   <h2 className="title-text center">We <span className="bold-700">Deliver</span>  <span className="bold-700">Results</span> </h2>
      <p className='description-tet'>Our clients have experienced <span className="bold-700">monumental success</span> in elevating their digital presence with our expertly crafted websites. Transform your brand's online identity today  </p>
   </div>
