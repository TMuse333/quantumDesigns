...
const About = () => {
  ...
  <Navbar/>
        ...
        <div className="about-container">
            ...
            <p className="description-text about-text">
            Our mission is to develop our visual capabilities to our highest level and use this skill to help other peoplelike you elevate your digital presence. We are
