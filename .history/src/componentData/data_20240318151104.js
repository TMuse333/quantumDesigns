let isMobile = window.innerWidth < 655;
let isTablet = window.innerWidth < 865 &&
window.innerWidth > 655 
let isDesktop = window.innerWidth >= 865
// Add event listener to update isMobile on window resize
window.addEventListener('resize', () => {
  isMobile = window.innerWidth < 655;
});

// Example: Log isMobile value on resize
window.addEventListener('resize', () => {
...
class Content {
  ...
  export const content1 = new Content(
    ...
    '../../images/q3-visuals-logo-2-no-bg.png',
    `Your website is your first impression to your new clients, making it essential that it stands out and looks professional. It can also be the the place where you manage accounts and other vital aspects to your business. We ensure your website is custom built to attract attention and leave the viewing knowing that 
...
export const serviceOfferings = [
  ...
  'Very Reusable and Quick Assembly',
  'Unique animations and interactivity'
]
...
export const designAdvantages = {
  ...
  description:'Anything you want, we can do. '+
 'with a background in drawing '+ 
 ' we can look at any design and emulate it with a style that you want. When you work with us the only '+
 'limitation is your imagination. Here are some design advantages when you work with us',
...
export const performanceAdvantages = {
  ...
  we ensure that everything aspect of your website is optimized for 
  performance and that you can have anything you want
  without worrying about your website being slow.
`,
