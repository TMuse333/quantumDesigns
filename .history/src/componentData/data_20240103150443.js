class Content {
  ...
  export const about2 = new Content(
   'src/images/tom-in-suit-2.jpg',
    ...
    'developped into drawing anime characters then taking the taste for art '+
    ...
    ' wanting to combine the two forms of literaryy and visual communiations via '+
    'websites to deliver a great human experience',
    true,
    '/booking',
    'Work with us',
    null,
