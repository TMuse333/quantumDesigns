class Content {
  ...
  export const about2 = new Content(
   'src/images/tom-in-suit-2.jpg',
    'Thomas has been dedicated to art since a young age and started out '+
    'drawing video game characters like Mario and Sonic, years later this '+
    'developed into drawing anime characters like Goku and Vegeta then taking the taste for art '+
    ' into the realm of creating websites to give others visually appealing '+
    ' websites. He later on became interested in literacy commuiactions as well'+
    ' wanting to combine the two forms of literary and visual communiations via '+
    'websites to create unique and stunning media.',
    true,
    null,
    null,
    null,
