class Content {
  ...
  export const about2 = new Content(
   ...
   "Thomas has been dedicated to art since a young age and began by drawing video game characters. Years later, he transitioned to drawing anime characters, cultivating a deep appreciation for the artistic craft. This passion led him to venture into the realm of website creation, where he applied his artistic skills to provide visually appealing websites. As his journey evolved, Thomas developed an interest in literary communications, aspiring to merge both literary and visual communication through websites, creating unique and stunning media.",
    true,
    null,
    null,
    null,
  ...
  export const content3 = new Content(
    ...
    'This includes vertical jump training and intense mediation',
    null,
    null,
    null,
    null,
