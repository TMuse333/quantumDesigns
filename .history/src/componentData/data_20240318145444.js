...
class Content {
  ...
  export const content1 = new Content(
    ...
    `Your website is your first impression to your new clients, making it essential that it stands out and looks professional. It can also be the the place where you manage accounts and other vital aspects
    to your business. We ensure your website is custom built to
