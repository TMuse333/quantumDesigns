...
export const designAdvantages = [
  ...
  },
  {
    ...
    description:'Implementing smooth animations and transitions is a breeze with React. Whether its subtle fade-ins, interactive hover effects, or dynamic page transitions, React allows you to create a fluid and visually appealing user interface. These animations not only enhance the aesthetics of your site but also contribute to a more immersive and memorable user journey.'
  },
  {
    name:'3D models',
