...
export const designAdvantages = [
  {
    ...
    description:`With React, your website is not confined to rigid templates. Instead, it's built as a collection of modular components. Each component serves a specific purpose, granting you the ability to customize and fine-tune individual elements precisely to your liking. This modular approach ensures that your website reflects your brand identity seamlessly.`
  },
  {
    name:'Appealing animations',
    description:`Elevate your website by seamlessly integrating 3D models. Whether you're showcasing products, creating immersive experiences, or simply adding a touch of sophistication, React allows you to effortlessly incorporate 3D models into your web pages. This interactive element brings your content to life and captivates your audience in ways static templates simply cannot.`
  },
  {
    name:'3D models',
    description:'We can create 3D models of your logo '+
    'to really make your website stand out and '+
    'give it a '
  },
  {
    name:'Dynamic Content Rendering',
    description:'React enables dynamic content rendering. Whether you want to display user-specific content, update your site in real-time, or personalize the user experience, React's efficient rendering ensures that changes are smooth and instantaneous. This level of dynamic customization goes beyond traditional static templates.'
  }
